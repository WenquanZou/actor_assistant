    ...
    render() {
        ...
        return (
            this.props.acts !== undefined && <div>
                <Typography variant='h2' align='center'>{this.props.filename}</Typography>
                <div style={{
                    border: '1px solid black',
                    padding: '10px',
                }} onClick={this.showState.bind(this)}>Show state in console log</div>
                <div className="scrollable">
                    {this.props.acts.map((act) => (
                    <>
                        <Act act_num={act.act_num} scenes={act.scenes}
